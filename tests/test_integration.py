...
class TestIntegration(unittest.TestCase):
    ...
    def test_multi_account_merge(self):
        ...
        # Account 1 holdings
        account1_stocks = [{"tradingsymbol": "RELIANCE", "exchange": "NSE", "quantity": 10, "average_price": 2400.0}]
        self.holdings_service.add_account_info(account1_stocks, "Account1")

        # Account 2 holdings
        account2_stocks = [{"tradingsymbol": "TCS", "exchange": "NSE", "quantity": 5, "average_price": 3500.0}]
        self.holdings_service.add_account_info(account2_stocks, "Account2")

        # Merge
        merged_stocks, _ = self.holdings_service.merge_holdings([account1_stocks, account2_stocks], [[], []])
    ...
    def test_session_token_workflow(self):
        ...
        stored = {"Account1": {"access_token": encrypted, "expiry": sessions["Account1"]["expiry"].isoformat()}}
