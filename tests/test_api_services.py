...
class MockKiteConnect:
    ...
    def renew_access_token(self, refresh_token: str, api_secret: str):
        """Mock token renewal"""
        return {"access_token": f"renewed_{refresh_token}", "refresh_token": "new_refresh_token"}
...
class TestHoldingsService(unittest.TestCase):
    ...
    def test_add_account_info(self):
        ...
        holdings = [{"quantity": 10, "average_price": 100.0}, {"quantity": 5, "average_price": 200.0}]
    ...
    def test_add_account_info_with_t1_quantity(self):
        ...
        holdings = [{"quantity": 10, "t1_quantity": 5, "average_price": 100.0}]
    ...
    def test_merge_holdings_multiple_accounts(self):
        ...
        stock_holdings = [[{"symbol": "RELIANCE"}], [{"symbol": "TCS"}]]
        mf_holdings = [[{"symbol": "MF1"}], [{"symbol": "MF2"}]]
    ...
    def test_add_nav_dates_with_instruments(self):
        ...
        mock_kite._mock_mf_instruments = [
            {"tradingsymbol": "MF1", "name": "Test Mutual Fund", "last_price": 25.5, "last_price_date": "2025-11-22"}
        ]
...
class TestAuthenticationManager(unittest.TestCase):
    ...
    def test_store_token(self):
        ...
        self.session_manager.set_token.assert_called_once_with("user123", "TestAccount", "new_access_token")
...
class TestSIPService(unittest.TestCase):
    ...
    def test_add_account_info(self):
        ...
        sips = [{"sip_id": "SIP001", "instalment_amount": 5000}, {"sip_id": "SIP002", "instalment_amount": 3000}]
    ...
    def test_merge_sips_single_account(self):
        ...
        all_sips = [[{"sip_id": "SIP001"}, {"sip_id": "SIP002"}]]
