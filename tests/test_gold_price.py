...
class TestGoldPriceService(unittest.TestCase):
    ...
    def test_get_24k_price_pm(self, mock_fetch):
        ...
        mock_fetch.return_value = {
            "prices": {"999": {"am": 128550.0, "pm": 128214.0}, "916": {"am": 117752.0, "pm": 117444.0}}
        }
    ...
    def test_get_24k_price_am(self, mock_fetch):
        ...
        mock_fetch.return_value = {"prices": {"999": {"am": 128550.0, "pm": 128214.0}}}
    ...
    def test_get_22k_price_am(self, mock_fetch):
        ...
        mock_fetch.return_value = {"prices": {"916": {"am": 117752.0, "pm": 117444.0}}}
    ...
    def test_get_18k_price_am(self, mock_fetch):
        ...
        mock_fetch.return_value = {"prices": {"750": {"am": 96500.0, "pm": 96413.0}}}
