...
from ..constants import DEFAULT_REQUEST_TOKEN_TIMEOUT, TOKEN_WAIT_POLL_INTERVAL
...
class AuthenticationManager:
    ...
    def __init__(self, session_manager, request_token_timeout: int = DEFAULT_REQUEST_TOKEN_TIMEOUT, state_manager=None):
    ...
    def _wait_for_request_token(self, account_name: str) -> str:
        ...
        wait_interval = TOKEN_WAIT_POLL_INTERVAL
        total_waited = 0
